...
class OlgaPgenComputation:
    def __init__(self, repertoires_path, n_threads, model):
    ...
    def compute_pgen(self, repertoire_file_path):
        ...
        command = 'olga-compute_pgen --' + self.model + ' -i ' + repertoire_file_path + ' -o ' + pgen_file_path + ' --seq_type_out aaseq --v_in 2 --j_in 3 '
